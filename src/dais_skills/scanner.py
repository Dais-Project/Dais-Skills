"""Main entry point for scanning GitHub repositories for skills."""

import asyncio
from typing import Optional, Callable
from .models import Skill
from .source_parser import parse_source
from .github_api import fetch_repo_tree
...
async def scan_repo(
    ...
    1. Parses the source string (owner/repo, URL, etc.)
    2. Fetches the repo tree from GitHub Trees API
    3. Discovers SKILL.md files in priority directories
    4. Fetches and parses each SKILL.md's frontmatter
    5. Returns a list of discovered skills
    ...
    Examples:
        ...
        >>> skills = await scan_repo("owner/repo@react-best-practices")
